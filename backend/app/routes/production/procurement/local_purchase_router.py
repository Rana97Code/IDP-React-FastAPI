...
@Local_purchase_router.post("/bmitvat/api/local_purchase/get_local_item_suggestions", response_model=List[ItemSuggest])
...
@Local_purchase_router.get("/bmitvat/api/local_purchase/get_local_item_details/{item_id}", response_model=ItemDetailsModel, dependencies=[Depends(get_current_active_user)])
...
@Local_purchase_router.post("/bmitvat/api/local_purchase/add-local-purchase", dependencies=[Depends(get_current_active_user)])
...
@Local_purchase_router.get("/bmitvat/api/local_purchase/all_local_purchase",response_model=List[ServicePurchaseFetch], dependencies=[Depends(get_current_active_user)])
