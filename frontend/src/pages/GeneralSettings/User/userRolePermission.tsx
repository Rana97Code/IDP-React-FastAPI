...
const userRolePermission = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('User Role Permission Table'));
    });
    ...
    return (
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                <h2 className="text-xl font-bold">Role-Permission</h2>
            </div>
                    ...
                    <div className="mb-5">
                        <form className="space-y-5 pt-4">
                            <div className="grid grid-cols-5 gap--x-2 gap-y-3">
                                <label htmlFor="userName" className='col-span-1 text-base'>Role Name</label>
                                <input id="userName" type="text" placeholder="Enter Role Name" className="form-input py-2.5 text-base col-span-4" name="user_name" />
                            </div>
